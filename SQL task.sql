...
Version: 1.0
ver CN - Adapted for MySQL - Mark MCCarthy 12/10/2022
--------------------------------------------------------------------
*/
...
CREATE TABLE production_brands (
	brand_id INT NOT NULL UNIQUE AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE sales_stores (
	store_id INT NOT NULL UNIQUE AUTO_INCREMENT PRIMARY KEY,
